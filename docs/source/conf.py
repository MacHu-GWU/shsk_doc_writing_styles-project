# -*- coding: utf-8 -*-
#
# shsk_doc_writing_styles documentation build configuration file, created by
...
package_name = "shsk_doc_writing_styles"
...
# Add data for Jinja2
try:
    from shsk_doc_writing_styles.docs import doc_data
except:
    doc_data = dict()
