...
So basically an ExecuteCode tool would have access to the same file system as a RunInference tool which could take a path to a file on that same virtual file system.
