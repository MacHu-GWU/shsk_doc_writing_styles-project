...
But **AI is not the secret sauce.** Most startups rent the AI from one of the big players—OpenAI, Anthropic, etc. Those will make billions. If you don't rent AI, you rent the compute. Cloud providers will win here.
